"""
Procedural generator for tree.oak.large asset.

Run with:
    blender --background --python tools/blender/generators/tree/oak_large/generate.py
"""
...
ASSET_ID = "tree.oak.large"

# Tunable parameters for this specific tree
PARAMS = {
    "total_height": 7.0,     # Adjusted to hit 3.5-5.0m actual height
    "trunk_ratio": 0.35,     # How much is trunk vs foliage
    "crown_radius": 0.9,     # Radius of crown (fits 2.0m footprint)
...
def generate():
    """Generate the tree.oak.large asset."""
    print(f"\n{'='*60}")
