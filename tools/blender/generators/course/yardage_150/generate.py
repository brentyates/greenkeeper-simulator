"""
Generator for course.yardage.marker.150

Run with:
    /Applications/Blender.app/Contents/MacOS/Blender --background --python tools/blender/generators/course/yardage_150/generate.py
"""
...
ASSET_ID = "course.yardage.marker.150"
...
def generate():
    ...
    marker = join_objects(parts, name="YardageMarker150")
