"""
Generator for course.yardage.marker.200

Run with:
    /Applications/Blender.app/Contents/MacOS/Blender --background --python tools/blender/generators/course/yardage_200/generate.py
"""
...
ASSET_ID = "course.yardage.marker.200"
...
def generate():
    ...
    marker = join_objects(parts, name="YardageMarker200")
