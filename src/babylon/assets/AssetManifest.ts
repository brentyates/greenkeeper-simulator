...
export const ASSET_MANIFEST: Record<string, AssetSpec> = {
  ...
  "equipment.mower.push": {
    ...
    footprint: [0.2, 0.3],
    origin: "base_center",
    notes: "Push reel mower. Handle height ~0.4m.",
  },
  "equipment.spreader": {
  ...
  "building.refill.station": {
    path: "/assets/models/buildings/refill_station.glb",
    heightRange: [0.6, 0.8],
    footprint: [0.8, 0.6],
    origin: "base_center",
    notes: "Fuel/supply refill station for maintenance equipment.",
  },
